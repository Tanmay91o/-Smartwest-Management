...
const Signup = ({ onLogin, API_URL = "https://smartwest-management.onrender.com" }) => {
    ...
    // to validate all fields are filled by user or not
    const validateForm = () => {
        const newErrors = {};
        if (!name.trim()) {
        ...
        <div className={signupStyles.pageContainer}>
            <div className={signupStyles.cardContainer}>
                <div className={signupStyles.header}>
                    ...
                    <p className={signupStyles.headerSubtitle}>Join Smartwest Management to manage your app</p>
                </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="text"
                                    ...
                                    className={`${signupStyles.input} ${errors.name ? "border-red-500" : "border-red-200"
                                        }`} placeholder=''
                                />
                            </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="email"
                                    ...
                                    className={`${signupStyles.input} ${errors.email ? "border-red-500" : "border-red-200"
                                        }`} placeholder=''
                                />
                            </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"}
                                    ...
                                    className={`${signupStyles.input} ${errors.password ? "border-red-500" : "border-red-200"
                                        }`} placeholder=''
                                />
