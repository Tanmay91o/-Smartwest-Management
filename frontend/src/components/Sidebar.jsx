...
import { ArrowDown, ArrowRight, ArrowUp, HelpCircle, Home, LogOut, Menu, Navigation, User, X } from 'lucide-react';

const MENU_ITEMS = [
    { text: "Dashboard", path: "/", icon: <Home size={20} /> },
    { text: "Challen", path: "/challen", icon: <ArrowRight size={20} /> },
    { text: "New Challen", path: "/new challen", icon: <ArrowRight size={20} /> },
    { text: "Manage Challen", path: "/manage challen", icon: <ArrowRight size={20} /> },
        ...
        <>
            ...
            >
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    <div className='flex-1 overflow-x-auto py-4 custom-scrollbar'>
            ...
            <motion.button onChange={() => setMobileOpen((prev) => !prev)}
