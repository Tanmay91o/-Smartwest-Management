export const dashboardStyles = {
    // Layout styles
    container: "min-h-screen p-4 md:p-6 text-sm",
...
export const navbarStyles = {
    ...
    logoImage: "w-25 h-15 rounded-xl overflow-hidden",

    // Text styles
    logoText: "lg:text-2xl md:text-3xl text-2xl text-gray-900 font-[550] lobster-regular",
    ...
    dropdownHeader: "px-3 py-3 border-b border-gray-100 ",
...
export const styles = {
    ...
    // Stat Card Styles
    statCards: {
        grid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-6 ml-68 ",
        card: "bg-white p-5 rounded-2xl shadow-sm border border-gray-100 ",
        cardHeader: "flex justify-between items-start",
        cardTitle: "text-3xl text-gray-600 font-bold",
    ...
    // Grid Layout
    grid: {
        main: "grid grid-cols-10 lg:grid-cols-3 gap-6",
        leftColumn: "lg:col-span-30 space-y-6 ",
        rightColumn: "lg:col-span-15 lg:-mx-2 space-y-6 px-4",
    },
